...
### 5.3.3 L'IA Avancée/Difficile


Au final nous avons le diagramme des classes suivant pour les IA. Il comporte la classe mère AI ainsi que les classes filles EasyAI, NormalAi et HardAI qui correspondent aux différentes IA.
Il y a aussi la classe Calculation qui comporte des méthodes permettant aux IA de faire différents calculs et la classe AttackRouteCalculation que seule l'IA avancée utilise.

![Ai](rapport/Ai_3.Final.png)
